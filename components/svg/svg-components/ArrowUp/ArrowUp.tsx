...
export const ArrowUp: SVGModule = (props) => (
  <svg width="21" height="13" viewBox="0 0 21 13" fill="white" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect y="9.89954" width="14" height="3" rx="1.5" transform="rotate(-45 0 9.89954)" />
